...
<!--                  <a :href="fileHref+'/'+fileList[index]" :download="fileList[index]">{{ item }}</a>-->
                  <a @click="downloadFile(fileList[index])">{{ item }}</a>
...
<!--                    &lt;!&ndash; <el-button size="mini" type="success" icon="el-icon-download" circle class="right-div" @click="downloadFile(item)"></el-button> &ndash;&gt;-->
<!--                  </a>-->
                  <el-button size="mini" type="success" icon="el-icon-download" circle class="right-div" @click="downloadFile(fileList[index])"/>
                </el-col>
              </el-row>
            </div>
    ...
    <div id="graduation-status">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
        ...
        <el-form-item>
          <el-button class="right-div" size="medium" type="primary" style="margin-right:25px;" @click="updateForm(props.row)">确认修改</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
