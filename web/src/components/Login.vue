  ...
  <div id="login" class="wrap">
    <div class="container">
      ...
      <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" >
        ...
        <el-form-item>
          <el-checkbox v-model="memory" style="margin-left: 211px">记住密码</el-checkbox>
        </el-form-item>
  ...
  export default {
    ...
    mounted(){
      if (localStorage.getItem('username'))
      {
        ...
        var bytes = CryptoJS.AES.decrypt(localStorage.getItem("pd"),"sdg56sf84gs8d");
        //console.log(localStorage.getItem("pd"));
        var originpd = bytes.toString(CryptoJS.enc.Utf8);
        //console.log(originpd);
        this.ruleForm2.checkPass= originpd;
      }
    },
    data(){
            ...
            this.$ajax.get('/api/login', {params: loginParams}).then( res => {
              ...
              if(res.data.errCode == 10){
                if (_this.memory)
                {
                    ...
                    var cText = CryptoJS.AES.encrypt(this.ruleForm2.checkPass,"sdg56sf84gs8d").toString();
                    localStorage.setItem("pd",cText);
                }
                else if (!_this.memory)
                {
                  localStorage.clear();
                }
                var userModel = {}
